=== Woocommerce Product Options Plugin, Custom Product Addons ===
...
Woocommerce Product add-ons plugin enables you to add custom product options (free & paid) and associate them with all or specific products so that customers can select their preferences and customize the end products as they wish. It is a helpful tool that allows merchants to boost revenues by offering customization options in addition to products.

With WooCommerce Product Addons Plugin you can add multiple types of custom fields such dropdown, multi-select to new product options.  For example, by using Woocommerce product color options, they can select a favorite color for ordering shirts, or large size in shoes. It helps them narrow down the choice and get the required product. 

Get more features in the Pro version of [WooCommerce Product Options Plugin](https://www.fmeaddons.com/woocommerce-plugins-extensions/custom-fields-additional-product-options.html "WooCommerce Product Options Plugin")

### Key Benefits Of WooCommerce Product Addons ###

* Deliver products as per the instructions provided in the fields
* Add product option to know consumers’ interests
...
### Key Features of Woocommerce product options Plugin ###
